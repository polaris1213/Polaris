...
const ui = {
  ...
  "hero.headLead": { ja: "重圧の中でも", en: "I build systems that" },
  "hero.headAccent": { ja: "揺るがないシステムを。", en: "hold up under pressure." },
  "hero.subtitle": {
    ja: "バックエンドの基盤から、人が実際に触れるインターフェースまで。信頼性が高く、丁寧に設計されたソフトウェアを設計・実装します。現在、新しい機会を歓迎しています。",
    en: "I design and ship reliable, well-architected software — from backend systems to the interfaces people actually touch. Currently open to new opportunities.",
  },
